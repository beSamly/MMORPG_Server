...
#ifndef GOOGLE_PROTOBUF_INCLUDED_LoginRes_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_LoginRes_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_LoginRes_2eproto
...
struct TableStruct_LoginRes_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_LoginRes_2eproto;
namespace Protocol {
class LoginRes;
...
class LoginRes final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_LoginRes_2eproto;
};
// ===================================================================
...
inline int32_t LoginRes::_internal_result() const {
  return _impl_.result_;
}
inline int32_t LoginRes::result() const {
  // @@protoc_insertion_point(field_get:Protocol.LoginRes.result)
  return _internal_result();
}
inline void LoginRes::_internal_set_result(int32_t value) {
  
  _impl_.result_ = value;
}
inline void LoginRes::set_result(int32_t value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_LoginRes_2eproto
