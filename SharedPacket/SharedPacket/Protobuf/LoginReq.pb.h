...
#ifndef GOOGLE_PROTOBUF_INCLUDED_LoginReq_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_LoginReq_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_LoginReq_2eproto
...
struct TableStruct_LoginReq_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_LoginReq_2eproto;
namespace Protocol {
class LoginReq;
...
class LoginReq final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_LoginReq_2eproto;
};
// ===================================================================
...
inline const std::string& LoginReq::email() const {
  // @@protoc_insertion_point(field_get:Protocol.LoginReq.email)
...
void LoginReq::set_email(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.email_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.LoginReq.email)
}
inline std::string* LoginReq::mutable_email() {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:Protocol.LoginReq.email)
  return _s;
}
...
inline std::string* LoginReq::release_email() {
  // @@protoc_insertion_point(field_release:Protocol.LoginReq.email)
...
inline void LoginReq::set_allocated_email(std::string* email) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Protocol.LoginReq.email)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_LoginReq_2eproto
