...
void GameSystemUpdater::SyncPlayerPosition(vector<sptr<Player>>& players)
{
	...
	{
		Packet packetUpdatePosition = BuildPositionUpdatePacket(from);
...
void GameSystemUpdater::SyncProjectilePosition(vector<sptr<Player>>& players, vector<sptr<TransformEntity>> projectiles)
{
	...
	{
		Packet packetUpdatePosition = BuildPositionUpdatePacket(projectile);
...
Packet GameSystemUpdater::BuildPositionUpdatePacket(sptr<TransformEntity> transform)
{
